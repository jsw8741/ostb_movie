...
public class SecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http, MvcRequestMatcher.Builder mvc) throws Exception {
		...
		.authorizeHttpRequests((authorize) -> authorize
				.requestMatchers(mvc.pattern("/"), mvc.pattern("/login/**"), mvc.pattern("/oauth/**"), mvc.pattern("/members/**")).permitAll()
				.requestMatchers(mvc.pattern("/FAQ/**"), mvc.pattern("/notice/**"), mvc.pattern("/lost/**"), mvc.pattern("/chatt/**")).permitAll()
